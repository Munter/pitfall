...
export function rotateLeft(layout: TrapLayout): TrapLayout {
  const rotatedLayout: TrapLayout = {
    ...
    headquarter: layout.headquarter ? [-layout.headquarter[1], layout.headquarter[0]] : undefined,
...
export function flipX(layout: TrapLayout): TrapLayout {
  const flippedLayout: TrapLayout = {
    name: layout.name,
    description: layout.description,
    headquarter: layout.headquarter ? [-layout.headquarter[0], layout.headquarter[1]] : undefined,
